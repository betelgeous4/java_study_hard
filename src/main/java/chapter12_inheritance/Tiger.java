...
public class Tiger extends Animal { //(자식) 클래스명 extends (부모) 클래스명 을 통해 상속 가능
    ...
    @Override                         // @Override 가 붙어있다면 해당 메서드는 상속을 받았다는 의미이다.
    ...
    @Override
    public void move() {
//        super.move();              //super()는 생성자에 해당 / super.메서드명() 은 부모 클래스의 메서드명을 호출
