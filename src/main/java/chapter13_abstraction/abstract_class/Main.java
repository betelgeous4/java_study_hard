...
//                System.out.println(this.getName() + "에서 " + "[" + model +"] 모델을 생산중입니다.");
//            }
//
//            @Override
//            public void manage() {
...
//        factory1.produce("백색 가전 냉장고");
        // 위의 클래스는 익명 클래스로, Java17에 적용되었다.
        // 재사용하지 않고 한 번만 사용하고 치울 예정이라면 사용하기에 용이할 것
        ...
        // 슈퍼클래스의 일반 메서드를 서브 클래스에서 호출한 예시 -> @Override 를 하지 않았는데
        // 사용이 가능하다. 부모 클래스에서 정의된 것을 그대로 쓴다면 @Override 를 굳이 하지 않아도 되고
        // 재정의를 하지 않을 것이면 (구현부를 수정하지 않을 거면) @Override 를 굳이 안 해도 된다.
